...
export type RestSiteChoice = 'HEAL' | 'UPGRADE' | 'DIG' | 'LIFT' | 'RECALL' | string
...
export interface Relic {
  ...
  props?: {
    ...
    cards?: { name: string, value: { id: string, floor_added_to_deck?: number, current_upgrade_level?: number } }[]
  }
}
...
export interface FloorPlayerStats {
  ...
  cards_enchanted?: { card: { id: string, floor_added_to_deck?: number }, enchantment: string }[]
